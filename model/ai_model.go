...
type AiModel struct {
	...
	Name string `json:"name" gorm:"column:name;type:varchar(100);not null;default:'';size:100;uniqueIndex:uk_name;comment:名称"`
	Enabled int8 `json:"enabled" gorm:"column:enabled;type:tinyint(2);not null;default:0;precision:2;scale:0;comment:是否启用"`
	MaxOutputTokens uint64 `json:"max_output_tokens" gorm:"column:max_output_tokens;type:bigint(20) unsigned;not null;default:0;comment:最大输出token"`
