...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.sessionDo.UseModel(&table.Session{})
...
func (s sessionDo) Create(values ...*table.Session) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sessionDo) CreateInBatches(values []*table.Session, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sessionDo) Save(values ...*table.Session) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sessionDo) First() (*table.Session, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*table.Session), nil
	}
}

func (s sessionDo) Take() (*table.Session, error) {
...
func (s sessionDo) Last() (*table.Session, error) {
...
func (s sessionDo) Find() ([]*table.Session, error) {
	result, err := s.DO.Find()
	return result.([]*table.Session), err
}

func (s sessionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*table.Session, err error) {
	buf := make([]*table.Session, 0, batchSize)
...
func (s sessionDo) FindInBatches(result *[]*table.Session, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sessionDo) FirstOrInit() (*table.Session, error) {
...
func (s sessionDo) FirstOrCreate() (*table.Session, error) {
...
func (s sessionDo) FindByPage(offset int, limit int) (result []*table.Session, count int64, err error) {
...
func (s sessionDo) Delete(models ...*table.Session) (result gen.ResultInfo, err error) {
